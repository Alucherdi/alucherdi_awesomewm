-- LuaRocks is installed, make sure that packages installed through it are
...
-- beautiful.init("/home/alucherdi/.config/awesome/theme/theme.lua")
beautiful.init(gears.filesystem.get_themes_dir() .. "default/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    local function volume_control(step)
        local cmd
        if step == 0 then
